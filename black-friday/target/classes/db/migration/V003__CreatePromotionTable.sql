...
INSERT INTO promotion(promotion_id, promotion_name, commodity_id, original_price, promotion_price,
                      start_time, end_time,
                      status, total_stock, available_stock, lock_stock, image_url)
VALUES (UUID(), 'Iphone13 low price', 'b859ee94-20f1-11ed-861d-0242ac120002', 999, 899,
        CURRENT_TIMESTAMP(), '2023-12-26 00:00:00', 1, 500, 500, 0, 'Iphone13'),
       (UUID(), 'MacBook Pro Black Friday Special', 'b859ee94-20f1-11ed-861d-0242ac120003', 1699,
        1499, CURRENT_TIMESTAMP(), '2023-12-26 00:00:00', 1, 5000, 5000, 0, 'MacBookPro');
